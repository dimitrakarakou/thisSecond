...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addInfo.putString("message2", "How can I get back to first fragmaner");
        mainFrag.setArguments(addInfo);

        getSupportFragmentManager().beginTransaction().add(R.id.fragment, mainFrag).commit();
    }
